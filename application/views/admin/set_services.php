...
<div class="container-fluid text-end mb-3">
  <a href="<?= base_url('pull/service'); ?>" class="btn btn-yfarms " data-bs-target="#mModal" data-bs-toggle="modal" data-title="New Service Category ">
      ...
      <tr>
        ...
        <td class="dropstart py-1">
          ...
          <div class="dropdown-menu dropdown-menu-end">
            <a href="<?= base_url('pull/service/'.$row['id']); ?>" class="dropdown-item " data-title="Update Expense Category" data-bs-target="#mModal" data-bs-toggle="modal"><i class="bi-pencil-square"></i> Edit Category
            </a>
            <a href="<?= base_url('drop/services/'.$row['id']); ?>" class=" dropdown-item" data-bs-target="#mModalX" data-bs-toggle="modal">
...
<?php if (count($services) < 1) { ?>
      <tr><td colspan="5" class="p-5 text-danger text-center">No data available</td></tr>
<?php } ?>
    </tbody>
  </table>
</div>
